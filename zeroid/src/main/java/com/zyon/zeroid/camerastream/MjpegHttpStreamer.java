...
final class MjpegHttpStreamer {
    ...
    private void workerRun() {
    	Log.i(TAG, "listen for connection");
        while (mRunning) {
            try {
            	Log.i(TAG, "acceptAndStream");
                acceptAndStream();
            } // try
        ...
        try {
                ...
                synchronized (mBufferLock) {
                    while (!mNewJpeg) {
                        try {
                        	...
                        	Log.i(TAG, "stop() may have been called");
                            return;
                        } // catch
                    } // while
            ...
            if (stream != null) {
                try {
                	...
                	Log.i(TAG, "IOException closingStream");
            ...
            if (socket != null) {
                try {
                	...
                	Log.i(TAG, "IOException closingSocket");
            ...
            if (serverSocket != null) {
                try {
                	...
                	Log.i(TAG, "IOException closingServerSocket");
